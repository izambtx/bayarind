                ...
                <div class="card-body">
                    <form action="" method="post" class="mx-auto text-center mb-5">
                        ...
                        <div class="d-flex justify-content-center mx-5">
                            <input class="form-control my-3 mr-5" type="number" name="totalBelanja" id="totalBelanja" required placeholder=" Jumlah Uang…">
                            <button type="submit" class="btn btn-primary px-5 my-3 ml-5">Hitung</button>
                        </div>
                    </form>
                    <div class="mx-auto text-center mt-5">
                        <p>Kemungkinan Pembayaran</p>
                        <?php if (!empty($combinations)) : ?>
                            <?php foreach ($combinations as $pecahan => $count) : ?>
                                <button type="button" class="btn btn-secondary mx-3 my-3 rounded px-5 py-3"><?= $pecahan; ?>: <?= $count; ?> lembar</button>
                            <?php endforeach; ?>
                        <?php else : ?>
                            <p>Tidak ada kombinasi yang dapat dibuat.</p>
                        <?php endif; ?>
                        <button type="button" class="btn btn-primary mx-3 my-3 rounded px-5 py-3">UANG PAS</button>
                    </div>
                </div>
            </div>
        </div>
