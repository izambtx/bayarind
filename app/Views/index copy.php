                ...
                <div class="card-body">
                    <form action="" method="post" class="mx-auto text-center mb-5">
                        ...
                        <div class="d-flex justify-content-center mx-5">
                            <input class="form-control my-3 mr-5" type="number" name="totalBelanja" id="totalBelanja" required <?php if ($results) : ?> value="<?= $totalBelanja; ?>" <?php else : ?> placeholder=" Jumlah Uang…" <?php endif; ?>>
                    ...
                    <div class="mx-auto text-center mt-5">
                        ...
                        <?php if ($results) : ?>
                            <?php foreach ($results as $r) : ?>
                                <button type="button" class="btn btn-secondary mx-3 my-3 rounded px-5 py-3"><?= "Rp" . number_format($r, 2, ',', '.'); ?></button>
                            <?php endforeach; ?>
                        <?php endif; ?>
